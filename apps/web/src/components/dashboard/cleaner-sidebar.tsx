...
const NAV_ITEMS = [
    ...
    { icon: Briefcase, label: 'Available Jobs', href: '/cleaner/jobs' },
    { icon: Calendar, label: 'My Schedule', href: '/cleaner/schedule' },
...
export function CleanerSidebar({ isOnline = false, onToggleOnline }: CleanerSidebarProps) {
                ...
                <div className="flex flex-col h-full">
                    ...
                    <div className="p-6 border-b">
                        <Link href="/" className="text-2xl font-bold text-green-600">
                            <span>Fixelo</span>{' '}
                            <span className="text-sm font-normal text-gray-500">Pro</span>
                        </Link>
                    </div>
